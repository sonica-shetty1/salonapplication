...
public class Barber extends AppCompatActivity {
    ...
    private void addListenerOnButton1() {
        ...
        imgButton = findViewById(R.id.youtube);
    ...
    private void addListenerOnButton2() {
        ...
        imgButton = findViewById(R.id.facebook);
    ...
    private void addListenerOnButton3() {
        ...
        imgButton = findViewById(R.id.google);
    ...
    private void addListenerOnButton4() {
        imgButton = findViewById(R.id.youtube1);
    ...
    private void addListenerOnButton5(){
        imgButton = findViewById(R.id.facebook1);
    ...
    private void addListenerOnButton6(){
        imgButton = findViewById(R.id.google1);
    ...
    private void addListenerOnButton7(){
        imgButton = findViewById(R.id.call);
    ...
    private void addListenerOnButton8(){
        imgButton = findViewById(R.id.call1);
